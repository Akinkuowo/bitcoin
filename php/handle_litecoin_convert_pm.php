...
if(isset($_POST['payment'])){
    ...
    if($amount == ""){
         ...
         if(mysqli_num_rows($result) === 1){
             ...
             if($amount > $BTCAmount){
                 header("location: ../users/convert-litecoin-to-bank.php?error=Sorry, the amount you want to convert is greater than your BTC wallet balance"); 
             }else{
                 header("location: ../users/select-pm-ltc-account.php"); 
             }
