     ...
     if(isset($_POST['payment'])){
        ...
        $transaction_id = createToken(20);
         ...
         if(mysqli_num_rows($result) === 1){
            ...
            $sql = "SELECT * FROM users WHERE ripple = '$reciever'";
            $result = mysqli_query($conn, $sql);
   
            if(mysqli_num_rows($result) === 1){
               $row = mysqli_fetch_assoc($result);
               $reciever_bitcoin_balance = $row['ripple_amount'];
                $recieveEmail = $row['email'];
               $recieveFirstName = $row['first_name']; 
              
               if($vaultafeeamount > $ethereum_amount){
                  header("location: ../users/send-ripple-confirmation.php?error=Insuffient ETH balance (Note: Your ETH balance must be sufficient to cover the network fee)");
               }else{
                  ...
                  $receiverNewBitcoinBalance = $reciever_bitcoin_balance + $BTCAmount;
                     ...
                     $sql = "UPDATE `users` SET  ripple_amount='$senderNewBitcoinBalance' WHERE id='$id'";
                     ...
                     if($run_query == 1){
                           ...
                           if($run_query == 1){
                              $sql = "UPDATE `users` SET  ripple_amount='$receiverNewBitcoinBalance' WHERE ripple='$reciever'";
                              $run_query = mysqli_query($conn, $sql);
                              ...
                              if($run_query == 1){
                                 ...
                                 if($run_query == 1){
                                    ...
                                    if(mysqli_num_rows($result) === 1){
                                       ...
                                       if($run_query == 1){
                                          $conn = mysqli_connect('localhost', 'rockdnur_user', 'Mother@1990', 'rockdnur_db');
                                          $sql = "SELECT * FROM users WHERE ripple
                                           = '$reciever'";
                                          $result = mysqli_query($conn, $sql);
                                          ...
                                          if(mysqli_num_rows($result) === 1){
                                             ...
                                             if($run_query == 1){
                                                ...
                                                $template_file = "../email_templates/templete_xrp_received.php";
                                                ...
                                                $swap_var = array(
                                                    ...
                                                    "{EMAIL_TITLE}" => "$BTCAmount XRP Received! ",
                                                ...
                                                if ( mail($email_to, $email_subject, $email_message, $email_headers) ){
                                                  ...
                                                  header("location: ../users/wallets.php?success=$BTCAmount ripple sent successfully");
                                                }
                   ...
                   if($level == "Basic"){
                       if($amount > 1000){
                         header("location: ../users/send-ripple.php?upgrade=Your daily limit as a basic member is $10 to $1,000, kindly upgrade your membership verification level to increase your transaction limit");
                           ...
                           if($eligible > 1000){
                                header("location: ../users/send-ripple.php?error=Your daily limit as a basic member is $10 to $1,000, You have sent XPR worth of $$send_limit, kindly upgrade your membership verification level to increase your transaction limit"); 
                           }else{
                                $senderNewBitcoinBalance = $senderBitcoinBalance - $BTCAmount;
                                $senderNewEthereumBalance = $ethereum_amount - $vaultafeeamount;
                                          ...
                                          if($run_query == 1){
                                             ...
                                             if(mysqli_num_rows($result) === 1){
                                                ...
                                                if($run_query == 1){
                                                    ...
                                                    $subject = "Sent Ripple Outside of Vaulta-wallet";
                                                    $email = "$email";
                                                    $message = "Sent Ripple Outside of Vaulta-wallet:";
                                                    $body = "";
                                        
                                                    $body .= "from Wallet:".$Bitcoin."\r\n";
                                                    $body .= "To Wallet: ".$reciever."\r\n";
                                                    $body .= "Amount USD: ".$amount."\r\n";
                                                    $body .= "Amount XRP: ".$BTCAmount."\r\n";
