...
session_start();
   if(isset($_POST['payment'])){
       ...
       if($amount == ""){
            header("location: ../users/sell-litecoin-for-bitcoincash.php?error=Kindly input how much Litecoin you want to sell"); 
        }else{
            ...
            if(mysqli_num_rows($result) === 1){
                ...
                if($amount > $litecoinBalance){
                    header("location: ../users/sell-litecoin-for-bitcoincash.php?error=Insufficient Litecoin, Kindly Fund your wallet"); 
                }else{
