...
session_start();
   if(isset($_POST['payment'])){
       ...
       if($amount == ""){
            header("location: ../users/buy-bitcoincash-with-litecoin.php?error=Kindly input how much Bitcoin Cash you want to buy"); 
        }else{
           $conn = mysqli_connect('localhost', 'rockdnur_user', 'Mother@1990', 'rockdnur_db');
            ...
            if(mysqli_num_rows($result) === 1){
                ...
                if($litecoin > $litecoinBalance){
                    header("location: ../users/buy-bitcoincash-with-litecoin.php?error=Insufficient litecoin balance, Kindly Fund your wallet"); 
                }else{
                    ...
                    if($run_query == 1){
                        ...
                        if($run_query == 1){
                            ...
                            header("location: ../users/buy-bitcoincash-with-litecoin.php?error=An error occur");
                        }
