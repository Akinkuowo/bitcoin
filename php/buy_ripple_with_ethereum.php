...
session_start();
   if(isset($_POST['payment'])){
       ...
       if($amount == ""){
            header("location: ../users/buy-ripple-with-ethereum.php?error=Kindly input how much Ripple you want to buy"); 
        }else{
            ...
            if(mysqli_num_rows($result) === 1){
                ...
                if($ethereum > $ethereumAmount){
                    header("location: ../users/buy-ripple-with-ethereum.php?error=Insufficient Fund Kindly select a different payment method"); 
                }else{
                  
                    
                    $ethereumMinus = $ethereumAmount - $ethereum;
                    $rippleAdd = $ripleBalance + $amount;
                    ...
                    if($run_query == 1){
                        ...
                        if($run_query == 1){
                            ...
                            header("location: ../users/buy-ripple-with-ethereum.php?error=An error occur");
                        }
